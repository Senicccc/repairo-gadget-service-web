<x-guest-layout>
    <section class="flex flex-col items-center justify-center px-6 py-8 mx-auto min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <!-- Brand Name -->
        <h1 class="mb-6 text-3xl font-bold text-red-600">
            Repairo
        </h1>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4 md:space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="remember_me" name="remember" type="checkbox"
                                    class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-red-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-red-500 dark:ring-offset-gray-800">
                            </div>
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm font-medium text-red-600 hover:underline dark:text-red-400">
                                Forgot password?
                            </a>
                        @endif
                    </div>
